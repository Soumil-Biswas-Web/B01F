...
export default function TheWorld () {
    return(
        <div className="theWorld">
            ...
            <h2>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Audax negotium, dicerem impudens, nisi hoc institut translatum ad philosophos nostros esset.</h2>
